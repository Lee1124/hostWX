...
const qqVideo = {
	getVideoes(vid) {
		...
		for (const platform in platforms) {
			var videoUrl = 'https://vv.video.qq.com/getinfo?otype=json&appver=3.2.19.333&platform=' + platforms +
				'&defnpayver=1&vid=' +
				vid;
			var host;
...
function requestVideoUrls(part_format_id, vid, fileName, host, videoCount) {
	var keyApi = "https://vv.video.qq.com/getkey?otype=json&platform=11&format=" + part_format_id + "&vid=" + vid +
